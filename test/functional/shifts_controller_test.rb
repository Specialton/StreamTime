...
class ShiftsControllerTest < ActionController::TestCase
  ...
  test "should create shift" do
    assert_difference('Shift.count') do
      post :create, shift: { end_datetime: @shift.end_datetime, start_datetime: @shift.start_datetime }
    end
  ...
  test "should update shift" do
    put :update, id: @shift, shift: { end_datetime: @shift.end_datetime, start_datetime: @shift.start_datetime }
    assert_redirected_to shift_path(assigns(:shift))
  end
